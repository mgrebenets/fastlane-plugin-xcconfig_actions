...
|              | staticlib                                                         |
|              | mh_object                                                         |
| References   | [DEAD_CODE_STRIPPING](#dev9ed8cb7ad)                              |
...
| DefaultValue    | debug-only                                                                                                                    |
| Description     | Enforce exclusive access to memory                                                                                            |
...
|                 | compile-time                                                                                                                  |
|                 | none                                                                                                                          |
| References      | [__SWIFT_ENFORCE_EXCLUSIVE_ACCESS_FULL_ENFORCEMENT_FULL_DEBUG](#__SWIFT_ENFORCE_EXCLUSIVE_ACCESS_FULL_ENFORCEMENT_FULL_DEBUG) |
...
|                 | [SWIFT_INDEX_STORE_ENABLE](#SWIFT_INDEX_STORE_ENABLE)                                                                         |
|                 | [__SWIFT_ENFORCE_EXCLUSIVE_ACCESS_FULL_ENFORCEMENT_FULL_DEBUG](#__SWIFT_ENFORCE_EXCLUSIVE_ACCESS_FULL_ENFORCEMENT_FULL_DEBUG) |
...
|                               |                                                                               |
|-------------------------------|-------------------------------------------------------------------------------|
| CommandLinePrefixFlag         | -\$([DEPLOYMENT_TARGET_CLANG_FLAG_NAME](#DEPLOYMENT_TARGET_CLANG_FLAG_NAME))= |
| Condition                     | \$([USE_LLVM_TARGET_TRIPLES_FOR_LD](#USE_LLVM_TARGET_TRIPLES_FOR_LD)) != YES  |
| DefaultValue                  | \$(\$([DEPLOYMENT_TARGET_SETTING_NAME](#DEPLOYMENT_TARGET_SETTING_NAME)))     |
...
<div id="__SWIFT_ENFORCE_EXCLUSIVE_ACCESS_FULL_ENFORCEMENT_FULL_DEBUG" class="Subhead">

## 🔐 __SWIFT_ENFORCE_EXCLUSIVE_ACCESS_FULL_ENFORCEMENT_FULL_DEBUG

|                 |                                                                                                                                                                                                       |
|-----------------|-------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CommandLineArgs |                                                                                                                                                                                                       |
| `NO`            | -enforce-exclusivity=unchecked                                                                                                                                                                        |
...
| DefaultValue    | YES                                                                                                                                                                                                   |
| Name            | __SWIFT_ENFORCE_EXCLUSIVE_ACCESS_FULL_ENFORCEMENT_FULL_DEBUG                                                                                                                                          |
| Type            | Boolean                                                                                                                                                                                               |
| References      |                                                                                                                                                                                                       |
...
|-----------------|-----------------------------------------------------------------------------------------------------------------------------------------------------------------------------------------|
| CommandLineArgs | -target                                                                                                                                                                                 |
|                 | \$([CURRENT_ARCH](#dev23cfef338))-apple-\$([SWIFT_PLATFORM_TARGET_PREFIX](#SWIFT_PLATFORM_TARGET_PREFIX))\$([value](#value))\$([LLVM_TARGET_TRIPLE_SUFFIX](#LLVM_TARGET_TRIPLE_SUFFIX)) |
| DefaultValue    | \$(\$([DEPLOYMENT_TARGET_SETTING_NAME](#DEPLOYMENT_TARGET_SETTING_NAME)))                                                                                                               |
